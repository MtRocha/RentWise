...
Public Class HouseHelperForm
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            MessageBox.Show("Casa cadastrada com sucesso!", "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Me.Hide()
            HomeForm.lblUserName.Text = $"Olá, {UserSession.Nome}"
            HomeForm.Show()
        Catch ex As Exception
            MessageBox.Show("Erro ao cadastrar casa: " & ex.Message, "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private _caminhoImagem As String = ""
