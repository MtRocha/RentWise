...
Partial Class HouseHelperForm
    ...
    Private Sub InitializeComponent()
        ...
        lblTitle.TabIndex = 0
        lblTitle.Text = "Cadastrar Nova Casa"
        ' 
        ' lblName
        ' 
    ...
    Private WithEvents lblRentValue As Label
    Private WithEvents numRentValue As NumericUpDown
    Private WithEvents lblPostCard As Label
    Private WithEvents txtPostCard As MaskedTextBox
    Private WithEvents lblAddress As Label
    Private WithEvents txtAddress As TextBox
    Private WithEvents lblNumber As Label
    Private WithEvents numNumber As NumericUpDown
    Private WithEvents lblDistrict As Label
    Private WithEvents txtDistrict As TextBox
    Private WithEvents lblCity As Label
    Private WithEvents txtCity As TextBox
    Private WithEvents lblState As Label
    Private WithEvents lblImage As Label
    Private WithEvents picHouse As PictureBox
